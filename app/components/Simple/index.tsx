...
const Simple = () => {
    return (
        <div className="simple-bg relative">
            {/* Cambiar esto a diseño más de animales o arte */}
            ...
            <div className="mx-auto max-w-5xl py-24 px-6">
                <h3 className="text-center text-offwhite text-3xl lg:text-5xl font-semibold mb-6">Haz que cada momento con tu mascota sea inolvidable</h3>
                <div className="flex justify-center ">
                    <button className='text-xl font-semibold text-white py-4 px-6 lg:px-12 navbutton'>Reserva</button>
                </div>
            </div>
